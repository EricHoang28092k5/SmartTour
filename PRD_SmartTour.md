...
- **Auto-play thuyết minh (geofence):** hàng đợi **FIFO**, không cắt ngang bản đang phát; cooldown **5 phút**/POI cho kích hoạt tự động; không trùng POI đang phát hoặc đã có trong queue; khi bỏ qua do cooldown vẫn phát tín hiệu **`NarrationCompleted`** (để simulator / tích hợp không kẹt).
