...
namespace SmartTourBackend.Migrations
{
    ...
    [Migration("20260408134522_EnableRoutePoisMapping")]
    partial class EnableRoutePoisMapping
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("SmartTour.Shared.Models.RouteSession", b =>
                {
                    ...
                    b.HasIndex("PoiSequence");

                    b.ToTable("RouteSessions", (string)null);
                });
            ...
            modelBuilder.Entity("SmartTour.Shared.Models.RouteSessionPoi", b =>
                {
                    ...
                    b.ToTable("RouteSessionPois", (string)null);
                });
